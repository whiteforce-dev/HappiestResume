!function (t, e) {
    ...
    return function (t) {
        ...
        }, a = s.bind(null, "addEventListener"), c = s.bind(null, "removeEventListener");
        ...
        function p(t) {
            return function t(e) {
                var n = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : {}, o = l(e, "data-con"),
                    r = l(e, "data-key");
                r && (n[r] = e);
                for (var i = Array.from(e.children), a = o ? n[o] = {} : n, c = 0; c < i.length; c++) {
                    var s = i[c], u = l(s, "data-arr");
        ...
        function h(t) {
            var e = !(1 < arguments.length && void 0 !== arguments[1]) || arguments[1], n = function (t) {
                return "0" <= t && t <= "9" || "-" === t || "." === t
            };

            function o(o) {
                for (var r = t.value, i = t.selectionStart, a = i, c = "", s = i - 1; 0 < s && n(r[s]); s--) c = r[s] + c, a--;
                for (var u = i, l = r.length; u < l && n(r[u]); u++) c += r[u];
                if (0 < c.length && !isNaN(c) && isFinite(c)) {
                    var p = o.deltaY < 0 ? 1 : -1, d = o.ctrlKey ? 5 * p : p, h = Number(c) + d;
                    !e && h < 0 && (h = 0);
                    var f = r.substr(0, a) + h + r.substring(a + c.length, r.length), v = a + String(h).length;
        ...
        var y = Math.min, g = Math.max;

        function m(t, e, n) {
            t = t / 360 * 6, e /= 100, n /= 100;
            var o = Math.floor(t), r = t - o, i = n * (1 - e), a = n * (1 - r * e), c = n * (1 - (1 - r) * e),
                s = o % 6;
        ...
        function _(t, e, n) {
            var o, r = m(t, e, n), i = r[0] / 255, a = r[1] / 255, c = r[2] / 255;
            return [100 * (1 === (o = y(1 - i, 1 - a, 1 - c)) ? 0 : (1 - i - o) / (1 - o)), 100 * (1 === o ? 0 : (1 - a - o) / (1 - o)), 100 * (1 === o ? 0 : (1 - c - o) / (1 - o)), 100 * o]
        }
        ...
        function k(t, e, n) {
            var o, r, i, a = y(t /= 255, e /= 255, n /= 255), c = g(t, e, n), s = c - a;
            if (i = c, 0 === s) o = r = 0; else {
                r = s / c;
                var u = ((c - t) / 6 + s / 2) / s, l = ((c - e) / 6 + s / 2) / s, p = ((c - n) / 6 + s / 2) / s;
                t === c ? o = p - l : e === c ? o = 1 / 3 + u - p : n === c && (o = 2 / 3 + l - u), o < 0 ? o += 1 : 1 < o && (o -= 1)
            }
            return [360 * o, 100 * r, 100 * i]
        }

        function A(t) {
            var e, n, o, r, i, a, c, s, u, l = {
            ...
            for (var d in l) if (e = l[d].exec(t)) switch (d) {
                case"cmyk":
                    var h = f(p(e), 5), g = h[1], m = h[2], b = h[3], _ = h[4];
                    return 100 < g || 100 < m || 100 < b || 100 < _ ? null : v((a = g, c = m, s = b, u = _, c /= 100, s /= 100, v(k(255 * (1 - y(1, (a /= 100) * (1 - (u /= 100)) + u)), 255 * (1 - y(1, c * (1 - u) + u)), 255 * (1 - y(1, s * (1 - u) + u)))))).concat([1]);
                case"rgba":
                    var w = f(p(e), 6), A = w[2], C = w[3], S = w[4], O = w[5], j = void 0 === O ? 1 : O;
                    return 255 < A || 255 < C || 255 < S || j < 0 || 1 < j ? null : v(k(A, C, S)).concat([j]);
                case"hex":
                    var x = function (t, e) {
                    ...
                    return H = parseInt(H, 16) / 255, v((i = E, k.apply(void 0, v(i.match(/.{2}/g).map(function (t) {
                        return parseInt(t, 16)
                    }))))).concat([H]);
                case"hsla":
                    var P = f(p(e), 6), L = P[2], D = P[3], T = P[4], F = P[5], M = void 0 === F ? 1 : F;
                    return 360 < L || 100 < D || 100 < T || M < 0 || 1 < M ? null : v((n = L, o = D, r = T, o /= 100, [n, 2 * (o *= (r /= 100) < .5 ? r : 1 - r) / (r + o) * 100, 100 * (r + o)])).concat([M]);
                case"hsva":
                    var N = f(p(e), 6), X = N[2], I = N[3], V = N[4], Y = N[5], z = void 0 === Y ? 1 : Y;
        ...
        function C() {
            var t = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : 0,
                ...
                o = 3 < arguments.length && void 0 !== arguments[3] ? arguments[3] : 1, i = Math.ceil, a = {
                    h: t, s: e, v: n, a: o, toHSVA: function () {
                        var t = [a.h, a.s, a.v], e = t.map(i);
                        return t.toString = function () {
                            return "hsva(".concat(e[0], ", ").concat(e[1], "%, ").concat(e[2], "%, ").concat(a.a.toFixed(1), ")")
                        }, t
                    }, toHSLA: function () {
                        var t = w(a.h, a.s, a.v), e = t.map(i);
                        return t.toString = function () {
                            return "hsla(".concat(e[0], ", ").concat(e[1], "%, ").concat(e[2], "%, ").concat(a.a.toFixed(1), ")")
                        }, t
                    }, toRGBA: function () {
                        var t = m(a.h, a.s, a.v), e = t.map(i);
                        return t.toString = function () {
                            return "rgba(".concat(e[0], ", ").concat(e[1], ", ").concat(e[2], ", ").concat(a.a.toFixed(1), ")")
                        }, t
                    }, toCMYK: function () {
                        var t = _(a.h, a.s, a.v), e = t.map(i);
                        return t.toString = function () {
                        ...
                        return t.toString = function () {
                            var e = 1 <= a.a ? "" : Number((255 * a.a).toFixed(0)).toString(16).toUpperCase().padStart(2, "0");
        ...
        function S(t) {
            var e = {
                options: Object.assign({
                    lockX: !1, lockY: !1, onchange: function () {
                        return 0
                    }
                }, t), _tapstart: function (t) {
                    a(document, ["mouseup", "touchend", "touchcancel"], e._tapstop), a(document, ["mousemove", "touchmove"], e._tapmove), t.preventDefault(), e.wrapperRect = e.options.wrapper.getBoundingClientRect(), e._tapmove(t)
                }, _tapmove: function (t) {
                    var n = e.options, o = e.cache, r = n.element, i = e.wrapperRect, a = 0, c = 0;
                    if (t) {
            ...
            var n = e.options, o = e._tapstart;
            return a([n.wrapper, n.element], "mousedown", o), a([n.wrapper, n.element], "touchstart", o, {passive: !1}), e
        }
        ...
        var x = function () {
            ...
            return e = t, (n = [{
                key: "_preBuild", value: function () {
                    var t, e, n, o, r, i, a, c = this.options;
                    "string" == typeof c.el && (c.el = document.querySelector(c.el)), this._root = (e = (t = c).components, n = t.strings, o = t.useAsButton, r = function (t) {
                    ...
                    }, i), c.useAsButton && (c.parent || (c.parent = "body"), this._root.button = c.el), document.body.appendChild(this._root.root)
                }
            }, {
                ...
                key: "_buildComponents", value: function () {
                    var t = this, e = this.options.components, n = {
                        palette: S({
                            element: t._root.palette.picker,
                            wrapper: t._root.palette.palette,
                            onchange: function (e, n) {
                                var o = t._color, r = t._root, i = t.options;
                        ...
                        selectable: function () {
                            ...
                            elements: t._root.interaction.options, className: "active", onchange: function (e) {
                ...
                key: "_bindEvents", value: function () {
                    var t = this, e = this._root, n = this.options, o = [a(e.interaction.clear, "click", function () {
                    ...
                    if (!n.showAlways) {
                        o.push(a(e.button, "click", function () {
                            return t.isOpen() ? t.hide() : t.show()
                        }));
                        var r = n.closeWithKey;
                        o.push(a(document, "keyup", function (e) {
                            return t.isOpen() && (e.key === r || e.code === r) && t.hide()
                        })), o.push(a(document, ["touchstart", "mousedown"], function (n) {
                ...
                key: "_rePositioningPicker", value: function () {
                    var t = this._root, e = this._root.app;
                    ...
                    var o = t.button.getBoundingClientRect(), r = e.getBoundingClientRect(), i = e.style;
                    r.bottom > window.innerHeight ? i.top = "".concat(-r.height - 5, "px") : o.bottom + r.height < window.innerHeight && (i.top = "".concat(o.height + 5, "px"));
                    var a = {left: -r.width + o.width, middle: -r.width / 2 + o.width / 2, right: 0},
                        c = parseInt(getComputedStyle(e).left, 10), s = a[this.options.position];
                    r.left - c + s < 0 ? s = a.right : r.left - c - s > window.innerWidth && (s = a.left), i.left = "".concat(s, "px")
                }
            }, {
                ...
                key: "_saveColor", value: function () {
                    var t = this._root, e = t.preview, n = t.button, o = this._color.toRGBA().toString();
                ...
                key: "_clearColor", value: function () {
                    var t = this._root, e = this.options;
                ...
                key: "setHSVA", value: function () {
                    var t = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : 360,
                        ...
                        r = 4 < arguments.length && void 0 !== arguments[4] && arguments[4], i = this._recalc;
                    if (this._recalc = !1, t < 0 || 360 < t || e < 0 || 100 < e || n < 0 || 100 < n || o < 0 || 1 < o) return !1;
                    var a = this.components, c = a.hue, s = a.opacity, u = a.palette,
                        l = c.options.wrapper.offsetHeight * (t / 360);
                    c.update(0, l);
                    var p = s.options.wrapper.offsetHeight * o;
                    s.update(0, p);
                    var d = u.options.wrapper, h = d.offsetWidth * (e / 100), f = d.offsetHeight * (1 - n / 100);
                    return u.update(h, f), this._color = new C(t, e, n, o), this._recalc = i, this._recalc && this._updateOutput(), r || this._saveColor(), !0
                }
            }, {
