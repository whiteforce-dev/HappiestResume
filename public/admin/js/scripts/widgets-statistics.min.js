...
$(document).ready(function () {
  ...
  new ApexCharts(document.querySelector("#chart9"), options6).render(); // chart no 14
  ...
  new ApexCharts(document.querySelector("#chart10"), options6).render(); // chart no 14
  ...
  new ApexCharts(document.querySelector("#chart11"), options6).render(); // chart no 14
  ...
  new ApexCharts(document.querySelector("#chart12"), options6).render(); // chart no 14
