...
@section('content')
    <div class="col-lg-12 col-md-12 mt-4">
        <div class="card text-center border-primary">
                            ...
                            <nav>
                                <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                                    <a class="nav-item nav-link active" id="nav-profile-tab" data-toggle="tab"
                                        ...
                                        aria-selected="false">Chatbot Query</a>
                                    <a class="nav-item nav-link" id="nav-home-tab" data-toggle="tab" href="#nav-home"
                                        role="tab" aria-controls="nav-home" aria-selected="true">Form Query</a>
                                                    ...
                                                    @foreach ($companies as $in => $item)
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <ul>
                                                                    <li><b>Name: </b>
                                                                        {{ isset($item->name) ? $item->name : '-' }}</li>
                                                                    <li><b>Email: </b>
                                                                        {{ isset($item->email) ? $item->email : '-' }}
                                                                    </li>
                                                                    <li><b>Contact:
                                                                        </b>{{ isset($item->contact) ? $item->contact : '-' }}
                                                                    </li>
                                                                </ul>
            ...
            <td>
                @if ($item->status == '0')
                     <a href="{{ url('activeInactive-enquiry/' . $item->id) }}"
                ...
                @endif
                                ...
                                <div class="tab-pane fade show active" id="nav-profile" role="tabpanel"
                                    ...
                                    <table class="table table-striped table-sm" id="myTable">
                                        ...
                                        <tbody>
                                            @foreach ($chatBotQuery->data as $key => $item)

                                                <tr>
                                                    <td>{{ $key + 1 }}</td>
                                                    <td>
                                                        <ul>
                                                            <li><b>Name: </b> {{ $item->person_name }}</li>
                                                            <li><b>Email: </b> {{ $item->person_email }}</li>
                                                            <li><b>Contact: </b>{{ $item->person_phone }}</li>
                                                        </ul>
                                    ...
                                    <div class="center">
                                        @if ($pre != 0)
                                            <a href="{{ url('contact_queries') . '/' . $website . '?page=' . $pre }}"
                                                class="btn btn-success">Previous</a>
                                        @endif
                                        <a href="{{ url('contact_queries') . '/' . $website . '?page=' . $next }}"
