<div class="main-header">
    <div class="logo">
        <img src="{{URL::to('public').'/'}}front/images/logo1.png" alt="">
        {{--<img src="{{URL::to('public/natural.png')}}" alt="">--}}
    </div>
    ...
    <div class="header-part-right">
        ...
        <div class="dropdown">
            <div class="user col align-self-end">
                <img src="{{URL::to('public/admin').'/'}}images/faces/1.jpg" id="userDropdown" alt="" data-toggle="dropdown"
                     aria-haspopup="true" aria-expanded="false">
