<div class="main-header">
    {{--<div class="logo">
        <img src="{{URL::to('public/front/').'/'}}images/logo_admin.png" alt="">
    </div>--}}
    ...
    <div class="header-part-right">
        ...
        <div class="dropdown">
            ...
            <i class="fa fa-user-circle" role="button" id="dropdownMenuButton" data-toggle="dropdown"
                aria-haspopup="true" aria-expanded="false" style="font-size: 34px;color: #710971f2;padding-right:38px;">
                
                </i>
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                <div class="menu-icon-grid">
                     <a href="{{URL::to('dashboard')}}"><i class="i-Shop-4"></i> Home</a>
                    {{--<a href="#"><i class="i-Library"></i> UI Kits</a>--}}
                    {{--<a href="#"><i class="i-Drop"></i> Apps</a>--}}
                    {{--<a href="#"><i class="i-File-Clipboard-File--Text"></i> Forms</a>--}}
                    {{--<a href="#"><i class="i-Checked-User"></i> Sessions</a>--}}
 ...
 {{--                    <a href="{{ url('logout') }}"><i class="i-Checked-User"></i> Logout</a>--}}
                </div>
            </div>
        </div>
        <!-- Notificaiton -->
