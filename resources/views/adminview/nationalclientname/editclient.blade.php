...
<div class="breadcrumb">
    <h1 class="mr-2">Editnationalclient</h1>
    <ul>
        <li>
    ...
    <div class="card  border-primary">
        ...
        <div class="card-body">
            ...
            <div class="ul-widget5">
                <form class="needs-validation" novalidate="novalidate" method="post" action="{{ url ('/editclient')}}"enctype="multipart/form-data">
                    @csrf
                    <div class="form-row">
                        <div class="col-md-12 mb-3">
                            <label for="name">Edit client</label>
                            ...
                            <input class="form-control"  name="name"  value="{{$data['name'] }}" placeholder="addclientname" type="text">
                            <br>
