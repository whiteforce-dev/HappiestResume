...
<div class="breadcrumb">
    <h1 class="mr-2">Addnationalclient</h1>
    <ul>
        <li>
    ...
    <div class="card  border-primary">
        ...
        <div class="card-body">
            ...
            <div class="ul-widget5">
                <form class="needs-validation" novalidate="novalidate" method="post" action="{{ url('nationalclientadd') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="form-row">
                        <div class="col-md-12 mb-3">
                            ...
                            <input class="form-control"  name="name"  placeholder="addclientname" type="text">
                            <br>
                            {{-- <input class="form-control"  name="image"   placeholder="save logo " type="file" > --}}
                            @php
