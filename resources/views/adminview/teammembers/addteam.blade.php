...
@section('content')
    <div class="breadcrumb">
        <h1 class="mr-2">AddTeamMember</h1>
        <ul>
            <li>
        ...
        <div class="card  border-primary">
            ...
            <div class="card-body">
                ...
                <div class="ul-widget5">
                    <form class="needs-validation" novalidate="novalidate" method="post" action="{{ url('addteam') }}"
                        enctype="multipart/form-data">
                        @csrf
                        <div class="form-row">
                            <div class="col-md-12 mb-3">
                                <label for="name">Add Team Member</label>
                                ...
                                <br>
                                <input class="form-control" name="desigation" placeholder="desigation" type="text">
                                <br>
