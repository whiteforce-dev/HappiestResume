...
@section('content')
    <div class="breadcrumb">
        <h1 class="mr-2">Edit Achievement</h1>
        <ul>
            <li>
            ...
            <div class="card-body">
                ...
                <div class="ul-widget5">
                    <form class="needs-validation" novalidate="novalidate" method="post"
                        action="{{ url('editachivement') }}"enctype="multipart/form-data">
                        @csrf
                        <div class="form-row">
                            <div class="col-md-12 mb-3">
                                <label for="name">Edit Achievement </label>
                                ...
                                <input class="form-control" name="eventsname" value="{{ $data['eventsname'] }}"
                                    placeholder="enter events name " type="text">
                                <br>
                                ...
                                <input class="form-control" name="phototype" type="hidden" value="achivement">
                            </div>
                        </div>
                </div>
