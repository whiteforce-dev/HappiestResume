...
@section('content')
    <div class="breadcrumb">
        <h1 class="mr-2">Add Achievement</h1>
        <ul>
            <li>
            ...
            <div class="card-body">
                ...
                <div class="ul-widget5">
                    <form class="needs-validation" novalidate="novalidate" method="post"
                        action="{{ url('store-achivement') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="form-row">
                            <div class="col-md-12 mb-3">
                                <label for="name">Add Achievement</label>
                                ...
                                <br>
                                <input class="form-control" name="description" placeholder="name of description" type="text">
                                <br>
                                @php
