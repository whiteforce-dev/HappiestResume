...
<div class="breadcrumb">
    <h1 class="mr-2">List Of Related Candidates ({{isset($registrations_count)?$registrations_count:'0'}})</h1>
    <ul>
        <li>
...
<div class="col-lg-12 col-md-12 mt-4">
    <div class="card text-center border-primary">
        ...
        <div class="card-header bg-primary text-white">
            <h3 class="text-white">Manage All Related Candidates</h3>
            <h6 class="text-white">
                ({{$job->position}})
            </h6>
                ...
                <div class="ul-widget-s5__content">
                    ...
                    <div class="ul-widget-s5__section"><a class="ul-widget4__title"
                        ...
                        <p class="ul-widget-s5__desc">
                            <a href="mailto:{{ isset($item->email)? $item->email : '-'}}">
                ...
                <div class="ul-widget-s5__content">
                    <div class="ul-widget-s5__progress">
                        <div class="ul-widget-s5__stats"><span>Profile Complete :
                            ...
                            <strong>
                                <a class="badge badge-info" href="tel:{{ isset($item->contact)? $item->contact : '-'}}">
                                    {{$item->contact}}
                                </a>
                            </strong>
                        </div>
