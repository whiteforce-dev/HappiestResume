              ...
              <div class="col-lg-4">
                <div class="projectts">
                  <img src="{{url($item->image)}}">
                    ...
                    {{--  <button class="viewbutton" onclick="window.location.href='{{ url('build-resume').'/'.$item->id }}'">Preview</button>  --}}
                    <a href="{{ url('myResume').'/'.$item->id }}" type="button" class="btn btn-dark btn-lg">Preview</a>
                    </div>
                </div>
              </div>
        @endforeach
        ...
        <div class="modal-dialog">
            <div class="modal-content m_login">
                ...
                <div class="modal-body">
                    <h5 text-align="center">Are Sure You Want To Logout?</h5>
                    <br>
