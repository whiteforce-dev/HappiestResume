        ...
        <div class="card text-center border-primary">
            ...
            <div class="card-body">
                <div class="ul-widget5">
                    ...
                    <p style="font-size: 20px;font-weight: 700;color: darkgoldenrod;">Total Available Candiate According To Your Search :- &nbsp;&nbsp;&nbsp;<span class="badge badge-success" style="padding-left: 20px;padding-right: 20px;padding-top: 10px;padding-bottom: 10px;">{{ count($condition) }}</span></p>
                ...
                <button type="button" id="send_sms" class="btn btn-info">Send Message</button>
                  ...
                  <br>
                        @foreach ($condition as $in => $item)
                  
                            <?php
                                
                                $registration = \App\RegistrationModel::where('id',$item->user_id)->first();
                                if($registration == ''){
                                  continue;
                                }
