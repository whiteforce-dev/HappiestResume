...
@section('title','Admin | Add New Benefit')
@section('head')
        ...
        <div class="card-body">
            ...
            <div class="ul-widget5">
                <form class="needs-validation" novalidate="novalidate" method="post" id="myid"
                    action="{{ url('benefits') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="form-row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input class="form-control" id="icon" type="text" placeholder="Provide Icon Name"
                                name="icon" required="required" value="{{old('icon')}}">
                            <div class="valid-feedback">
                                Looks good!
                            </div>
                            <small>
                                <a href="{{url('https://cdn.materialdesignicons.com/4.5.95/')}}" style="color: red" target="_blank">
                                    Click here 
                                </a>
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <textarea class="form-control" id="description" placeholder="Provide Short Description"
                                maxlength="255" name="description" required="required">{{old('description')}}</textarea>
                            <div class="valid-feedback">
                                Looks good!
                            </div>
                        </div>
