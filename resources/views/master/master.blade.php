...
<head>
    ...
    <title>@yield('title') | Happiest Resume</title>
    <!-- Favicon icon -->
    ...
    ********************-->
    ...
    <div id="main-wrapper" class="menu-toggle">
        <div class="nav-header">
            <a href="{{ url('dashboard') }}" class="brand-logo" style="padding-left: 35px;"><img src="https://happiestresume.com/assets/images/logo-light.png" alt="" height="auto" width="100px">
                {{-- <img height="30" src="https://white-force.com/onrole/whiteforcelogo_portrait_color.png" alt="" />
                ...
                font-size: 12px;
                font-weight: 500;
            }"><img class="logo-box" src="{{ url('plusLogo.png') }}" alt=""></small> --}}
    ...
    <div class="modal right fade right-Modal" id="rightModal" tabindex="-1" role="dialog" aria-labelledby="rightModal">
