...
@section('content')
    ...
    <div class="content-body">
        <div class="container-fluid first-section">
                        ...
                        <div
                            ...
                            <div class="media">
                                ...
                                <div class="media-body">
                                    <h5 class="mt-1 mb-2">Hi <b></b>, welcome back!!</h5>
                                    <p class="mb-0"><b></b>
                                </div>
                            </div>
                            <style>
                        ...
                        <div class="row open-width">
                            <div class="col-lg-6 col-md-12 mb-4">
                                <div class="p-4 rounded d-flex align-items-center bg-primary text-white"><i
                                    ...
                                    <div>
                                        <h4 class="text-18 mb-1 text-white">Open Positions - <small>
                                                Month</small><span
                            ...
                            <div class="col-lg-6 col-md-12 mb-4">
                                <div class="p-4 rounded d-flex align-items-center bg-primary text-white"><i
                                        class="i-Big-Data text-32 mr-3"></i>
                                    <div>
                                        <h4 class="text-18 mb-1 text-white">Closed Positions - <small>
                                                Month</small><span
                                                style="font-weight: 700;
                                font-size: 45px;
                                position: absolute;
                            ...
                            <div class="carousel-inner">
                                    ...
                                    {{-- @foreach ($events as $key => $event)
                                        <div class="carousel-item imageBox {{ $key == 0 ? 'active' : '' }}">
                                            ...
                                            <div class="carousel-caption d-none d-md-block">
                                                ...
                                                <small></small>
                                                <h6 style="color: #b3ff59; margin: 0px;"></h6>
                                                <small></small>
                                ...
                                @else --}}
                                    <div class="carousel-item imageBox active">
                                        <img class="cimg" src="{{ url('assets/images/admin.png') }}" class="d-block w-100"
                                            alt="...">
                                        {{-- <div class="carousel-caption d-none d-md-block">
                        ...
                        <div class="card-body  ">
                            <div class="row">
                                ...
                                <div class="col-10 mt-3">
                                    <div class="row">
                                        <div class="col-12">
                                            <h4 class="text-20 text-dark">Candidate Offered </h4>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-6 mmonth">
                                        ...
                                        <div class="col-6">
                                            <h4 class="" style="color:#32325D"> </h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card-body  ">
                            <div class="row">
                                ...
                                <div class="col-10 mt-3">
                                    <div class="row">
                                        <div class="col-12">
                                            <h4 class="text-20 text-dark">Candidate Joined </h4>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-6 mmonth">
                                            <strong class="text-primary">&nbsp; Month
                                            </strong>
                                        </div>
                                        <div class="col-6">
                                            <h4 class="" style="color:#32325D">
            ...
            <div class="row res-flex">
                            ...
                            <div class="row">
                                <div class="col-sm-3 search-area">
                                    <input type="date" placeholder="Enter Date" class="form-control"
                                        value="" id="position_start_date">
                                </div>
                                <div class="col-sm-3 search-area">
                                    <input type="date" placeholder="Enter Date" class="form-control"
                                        value="" id="position_end_date">
                                </div>
                                <div class="col-sm-3 search-area">
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="card p-3">
                            <div class="row">
                                <div class="col-sm-3 search-area">
                                    <input type="date" placeholder="Enter Date" class="form-control"
                                        value="" id="company_start_date">
                                </div>
                                <div class="col-sm-3 search-area">
                                    <input type="date" placeholder="Enter Date" class="form-control"
                                        value="" id="company_end_date">
                                </div>
                                <div class="col-sm-3 search-area">
                ...
                {{-- <div class="col-sm-4 can-right 1200plus" style="display: none;">
        <h4 class="report-heading">Offered Candidate</h4>
        <div class="card p-3 mb-5"  style="height: 392px;">
            <div class="row mb-2">
                <div class="col-2">
                    <span class="badge badge-dark  my-3" style="height:30px;" id="countOfOffered">{{
                                $offered_candidate->count() }}</span>

                </div>
                <div class="col-10">
                    <select class="form-control my-3" onchange=" getoffered(this.value)" style="height:35px;">
            ...
            <div id="offeredContainer" style="height: 446px; overflow:auto">
                @if ($offered_candidate->count() == 0)
                <div align="center">
                ...
                <div style="border: 2px dashed #eb815378;border-radius: 10px; padding: 10px 10px; margin-bottom: 10px;">
                    <div class="project-info">
                        <div class="col-sm-8">
                            ...
                            <p class="text-dark mb-1">Joining Date - {{ ucwords($person?->joining_date) }}
                            </p>
                            <p class="text-dark mb-1">Time - 10:30 AM - 12:00 PM</p>
                        </div>
                        <div class="col-sm-4">
                            <span>Manager</span>
                            <h5 class="mb-2 pt-1 font-w50 text-black">{{ ucwords($person?->pco->name) }}
                            </h5>
                            <span>Recruiter</span>
    ...
    {{-- <script>
        ...
        function getInterview(managerId) {
