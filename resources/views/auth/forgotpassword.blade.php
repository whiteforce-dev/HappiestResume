                ...
                <div class="login" style="position: relative">
                    ...
                    <div class="main-loader submitModal" style="margin-top:-20px !important; z-index: 300;">
                        ...
                        <div class="name-loader">
                          <div class="name">
                            <label for="f-name">Registered Mobile Number</label>
                                       
                                        <input  id="reg_contact" name="contact" class="col-sm no-padding click click-courier" type="text" placeholder="Phone Number" required/>
                          ...
                          @enderror
                          <div class="name">
                            <label for="S-name">Email</label>
                            <input type="email" class="col-sm no-padding click click-courier" id="reg_email" name="reg_email"
                        ...
                        <div class="headline-loader">
                          <div class="password-star">
                            <div class="name">
                                <label for="n-number">New Password</label>
                            ...
                            <div class="name">
                              ...
                              <input class="col-sm no-padding click click-vendor" type="password" name="cpassword"
                                id="cpassword" autocomplete="off"/>
                            </div>
                            @error('cpassword')
                            {{ $message }}
                            @enderror
