                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <input class="form-control" id="title" type="text" placeholder="Enter Title" name="title"
                                required="required" value="{{$blogs->title}}">
...
<div class="col-lg-12 col-md-12 mt-4" style="margin-left:150px !important;margin-right:180px !important; margin-top:80px !important">
    <div class="card  border-primary">
        <!-- -->
        <div class="card-header bg-primary  text-white">
            <div>Edit Item (Blogs)</div>
