...
<div style="width:550px; color:#fff; float:left;">
    ...
    <!--About-->
      <div style="background:#040809; width:400px; text-transform:uppercase; font-size:23px; font-weight:300"> <img src="{{url('resume_yellow/assets/imgs/about.png') }}" style="display:inline-block; float:left; width:45px; "/>
...
<div style="width:350px; float:left;margin-top:40px">
    ...
    <div style=" color:#000; padding:30px">
      ...
      <div>
       ...
       @if($user_skill->skills == '"null"' || $user_skill->skills == null || $user_skill->skills == 'ul')
...
<div class="container text-center bottom-sec" style="text-align:center">
   ...
   <a href="{{ url('build-resume') }}" class="btn " style="background-color:#35322e;color:#fff;    text-decoration: none;">Back & Edit</a>
...
<a href="{{ url('user-dashboard') }}" class="btn btn-bubble btn-sm btn" style="padding: 1em 1em;background-color:#000;color: #fff;position: fixed;bottom: 8px;right: 13px;text-decoration:none">My Dashboard</a>
