...
">
        <div style="font-family:Calisto MT;background-color: #ffffff;text-align: center;margin: 0px auto;position: relative;"
            ...
            <table
                style="width: 100%;text-align: left;margin-left: 2%;table-layout: fixed;padding: 1% 0% 1% 1%;font-family:Calisto MT;">
                <tbody>
                    ...
                    <tr>
                        <td colspan="1" class="photo" style="width: 80pt;">
                            <div class="user_picblock" id="tour_user_picblock"
                                ...
                                <img class="global_img" id="profile_pic" src="{{URL::to('public').'/'.$user->image}}"
                                    alt="image"
                        ...
                        <td colspan="4">
                            <div class="pencil_hoverthis" id="tour_user_name">
                                <h2 style="font-size: 2.5rem;font-weight: initial;">
                                    <div style="color: #3b658a;outline: none" contentEditable=true
                                        ...
                                        onkeyup="Focusoutsection();" onfocus="Focussection('resu_per_name');"
                                        id="resu_html_name">
                            ...
                            <div class="pencil_hoverthis" id="tour_user_designation">
                                <h6 class="editable"
                                    ...
                                    spellcheck="false">
                                    <div contentEditable=true data-text="Enter Your Designation" style="outline: none;"
                                        class="resu_designation textWithSpace required" onkeyup="Focusoutsection();"
                                        onfocus="Focussection('resu_per_designation');" id="resu_html_designation">
                                        @if(isset($user_work_exp->designation)) {{$user_work_exp->designation}} @endif
                                    </div>
                                </h6>
                            </div>
                        </td>
                    ...
                    <tr onclick="selectedrow(this);" class="selectedrow">
                        <td colspan="5">
                            <div class="pencil_hoverthis res_margin0" unselectable="on" id="tour_tagline"
                                ...
                                <span class="number_bullet_container">
                                    <p contentEditable=true data-text="Enter your title here"
                                        ...
                                        @if(isset($user_work_exp->title)) {{$user_work_exp->title}} @endif</p>
                                </span>
                            </div>
                        </td>
                    </tr>
                                ...
                                <table cellpadding="0" cellspacing="0" width="300pt"
                                    ...
                                    <tr>
                                        <td style="text-align: right;"><img
                                                ...
                                                width="80pt" /></td>
                                        <td
                                            style="text-align:center;font-family: Calibri;text-transform: uppercase;color: #2a5479;font-weight: 700;font-size: 20pt;">
                                            Profile
                                        </td>
                    ...
                    <tr>
                            ...
                            <table width="60px" bgcolor="#1a7fd0" style="table-layout: fixed;">
                                <tr>
                                    <td style="text-align:center;border-radius: 50%;width:100%;height: 50px;">
                                        <img src="{{URL::to($education->icon)}}" style="margin-top:5px;
                        ...
                        <td bgcolor="#cccccc">
                            <table cellpadding="0" cellspacing="0" width="100%" style="">
                               ...
                               background: rgb(255, 136, 0);font-size: 24px;">@if(isset($education->education_name))
                                        {{$education->education_name}} @else Enter Education Name - Year @endif
                                    </td>
                                </tr>
                                <tr>
                                    <td
                                        style="padding: 10px 15px;color: #666666;background-color: #ffffff;border: solid thin #e1e1e1;">
                                        <table cellpadding="0" cellspacing="0" width="100%">
                                            <tr>
                                                <td style="font-size: 12pt;"><a
                                                        ...
                                                        {{$education->website}} @else Enter Website @endif</a>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="color: #666666;font-size: 12pt">
                                                    @if(isset($education->organization)) {{$education->organization}}
                                                    @endif
                                                </td>
                                            </tr>
                                        </table>
            ...
            <tr style="display: none">
                <td colspan="5">
                    <ul class="timeline"
                        ...
                        @foreach($user_educations as $index=> $education)
                        @if($index < 3) <li @if($index> 1) onclick="selectedrow_timeline(this);" @endif>
                            <div style="display: inline-block;position: relative;width: 100%;"
                                ...
                                <div class="editable_container pencil_hoverthis timeline_editblock"
                                    ...
                                    <h3 onkeyup="Focusoutsection();" onfocus="Focussection('resu_per_education');"
                                        education_icon="{{$education->icon}}" class="resu_education_txt_school"
                                        education_type="{{$education->type}}" id="resu_html_education10"
                                        ...
                                        @if(isset($education->education_name)) {{$education->education_name}} @endif
                                    </h3>
                                    <div style="padding: 15px;color: #666666;">
                                        ...
                                        <b
                                            ...
                                            <a onkeyup="SetLink(this);"
                                                ...
                                                target="_blank">@if(isset($education->website)) {{$education->website}}
                                                @endif</a></b>
                                        {{--@endif--}}
                                        <p onkeyup="Focusoutsection();" onfocus="Focussection('resu_per_education');"
                                            class="resu_education_txt resu_education_txt_school_board"
                                            id="resu_html_education10_txt" unselectable="on" contentEditable=true
                                            data-text="Enter {{$education->type}} @if($index < 2) school @else college @endif/Enter board name"
                                            style="outline: none;margin-bottom: 0px;">
                                            @if(isset($education->organization)) {{$education->organization}} @endif</p>
                                    </div>
                                </div>
                                <div class="resu_line"
                                ...
                                <div style="display: inline-block;position: relative;width: 100%;"
                                    ...
                                    <div class="timeline_circle"
                                        ...
                                        <span class="circle blue darken-2 z-depth-1-half" style="
                                                            ...
                                                            ">
                                            {{--<i class="{{$education->icon}}" aria-hidden="true"></i>--}}
                                            <img src="{{URL::to($education->icon)}}" style="width: 35px;" /></span>
                                    ...
                                    <div class="editable_container pencil_hoverthis timeline_editblock"
                                        ...
                                        <h3 onkeyup="Focusoutsection();" onfocus="Focussection('resu_per_education');"
                                            education_type="{{$education->type}}" education_icon="{{$education->icon}}"
                                            unselectable="on" class="resu_education_txt_school" contentEditable=true
                                        ...
                                        <div class="resu_line" style="padding: 15px;color: #666666;"><b
                                                style="outline:none;margin: 0px 0px 5px 0px;display: inline-block;width: 100%;">
                                                <a onkeyup="SetLink(this);" class="resu_education_txt_school_website"
                                                    href="@if(isset($education->website)) {{$education->website}} @endif"
                                                    unselectable="on" contentEditable="true"
                                                    style="outline: none;color:#07d !important;"
                                                    data-text="www.entercollegewebsite.com"
                                            ...
                                            <p onkeyup="Focusoutsection();"
                                                ...
                                                style="outline: none;margin-bottom: 0px;">
                                                @if(isset($education->organization)) {{$education->organization}} @endif
                                            </p>
                                        </div>
                                    </div>
                                </div>
            ...
            <tr>
                <td colspan="5" style="text-align: center;">
                    <div class="resu_archivement_fileblock" id="tour_user_achivement_img"
                        ...
                        <img class="global_img acheivement_image" src="{{URL::to('public').'/'.$user_achievemt->image}}"
                            style="width: 100%;float:left;margin-bottom: 15px;" align="left">
                        @else
            ...
            <tr>
                <td colspan="5">
                    <div class="archivement_editblock pencil_hoverthis" id="tour_user_achivement_txt"
                        ...
                        <h3 style="outline:none;margin-bottom: 5px;font-size: 16pt" contenteditable="true"
                            ...
                            @if(isset($user_achievemt->title)) {{$user_achievemt->title}} @endif</h3>

                        <span class="number_bullet_container">
                            <p onkeyup="Focusoutsection();" onfocus="Focussection('resu_per_experiance');"
                                class="exp_company_details1 acheivement_content" contentEditable="true"
                                unselectable="on" style="margin: 0px;outline: none;font-size: 14pt;"
                                data-text="@if(isset($user_achievemt->content)) {{$user_achievemt->content}} @else Enter achievement content here @endif">
                                @if(isset($user_achievemt->content)) {{$user_achievemt->content}} @endif</p>
                        </span>
                    </div>
                </td>
            </tr>
            ...
            <tr>
                <td colspan="5">
                    <div
                        ...
                        <h5 onkeyup="Focusoutsection();" onfocus="Focussection('resu_per_experiance');"
                            id="resu_html_experiance" class="exp_company_name" contenteditable="true" unselectable="on"
                            ...
                            @if(isset($user_work_exp->company)) {{$user_work_exp->company}} @endif</h5>
                        <b style="display: inline-block;width: 100%;padding:  8px 0px 3px 0px;">
                            <a style="outline: none;color:#07d !important;" onkeyup="SetLink(this);" target="_blank"
                                data-text="Enter company website Eg: www.companywebsite.com" unselectable="on"
                                class="exp_company_website" contenteditable="true"
                        ...
                        <div style="width: 100%;">
                            <b onfocus="Focussection('resu_per_experiance');" data-text="Position / Title"
                                class="exp_company_desig" contenteditable="true" unselectable="on"
                            ...
                            <div>
                                <div contentEditable="true" onfocus="Focussection('resu_per_experiance');"
                                    data-text="mm" required-message="Enter Start Month" maxlength="2"
                                    ...
                                    @if($user_work_exp->start_date) {{date('m',strtotime($user_work_exp->start_date))}}
                                    @endif</div>
                                <span
                                ...
                                <div contentEditable="true" required-message="Enter Start Year"
                                    onfocus="Focussection('resu_per_experiance');" data-text="yyyy" maxlength="4"
                                    ...
                                    @if($user_work_exp->start_date) {{date('Y',strtotime($user_work_exp->start_date))}}
                                    @endif</div>
                                <span
                                ...
                                <div contentEditable="true" required-message="Enter End Month"
                                    ...
                                    onfocus="Focussection('resu_per_experiance');" data-text="mm" maxlength="2"
                                    ...
                                    @if($user_work_exp->end_date) {{date('m',strtotime($user_work_exp->end_date))}}
                                    @endif</div>
                                ...
                                <div contentEditable="true" class="hidepresent end_year validateLength required2"
                                    onfocus="Focussection('resu_per_experiance');" required-message="Enter End Year"
                                    ...
                                    @if($user_work_exp->end_date) {{date('Y',strtotime($user_work_exp->end_date))}}
                                    @endif</div>
                                <div id="checkbox-present-box" style="margin-left: 10px;font-weight: bold;">
                                    ...
                                    <label class="form-check-label decleartion_checkbox present_for" for="job-status"
                                        id="present-checkbox-sign" style="padding-left: 25px;"></label>
                        ...
                        <span class="number_bullet_container">
                            <p onkeyup="Focusoutsection();" onfocus="Focussection('resu_per_experiance');"
                                ...
                                data-text="Describe your job Responsibilities.">@if(isset($user_work_exp->description))
            ...
            <tr>
                <td colspan="5" id="tour_user_skills">
                    <div class="pencil_hoverthis resu_skillblock res_margin0"
                        style="padding: 15px;background: #f5f5f5;display: inline-block;position: relative;z-index: 5;outline: none;margin-bottom: 15px;width: 100%;">
                        <h5
                            style="outline:none;font-family: Calibri;font-size: 20pt;margin-bottom: 8px; font-weight: bold;padding-bottom: 10px;border-bottom: solid thin #cccccc;">
                            Skills</h5>
                        <span class="number_bullet_container">
                            <p contenteditable="true" unselectable="on" onkeyup="Focusoutsection();"
                                onfocus="Focussection('resu_per_skills');" id="resu_html_skills"
                                style="margin:0px;outline: none;font-size:11pt;" contentEditable="true"
                                required-message="Please enter your skills" class="resu_html_skills required2"
                                ...
                                @if(isset($user_skills->skills)){{$user_skills->skills}} @endif</p>
                        </span>
                    </div>
                </td>
            </tr>
                        ...
                        <tbody>
                            <tr id="tour_user_location" onclick="personal_rowclick(this);">
                                ...
                                <td contenteditable="true" onkeyup="Focusoutsection();"
                                    onfocus="Focussection('resu_per_personal');" unselectable="on" class="edit_perblock"
                                    id="current_location"
 ...
 ">
                            ...
                            <tr id="tour_user_relocate" onclick="personal_rowclick(this);" class="">
                                <td
                                    style="font-family: Calibri;width: 30%;padding: 10px;background: #f7f7f7;border: solid thin #e1e1e1;font-weight: bold;">
                                    Willing to Relocate
                                </td>
 ...
 ">
                            ...
                            <tr id="tour_user_hobby" onclick="personal_rowclick(this);" class="">
                                <td
                                    style="font-family: Calibri;width: 30%;padding: 10px;background: #f7f7f7;border: solid thin #e1e1e1;font-weight: bold;">
                                    Hobby / Interest
                                </td>
                            ...
                            <tr id="communication_expertise" onclick="personal_rowclick(this);" class="">
                                <td
                                    style="font-family: Calibri;width: 30%;padding: 10px;background: #f7f7f7;border: solid thin #e1e1e1;font-weight: bold;">
                            ...
                            <tr id="tour_user_driving" onclick="personal_rowclick(this);" class="">
                                <td
                                    style="font-family: Calibri;width: 30%;padding: 10px;background: #f7f7f7;border: solid thin #e1e1e1;font-weight: bold;">
                ...
                <td colspan="5" id="tour_user_declaration"
                    ...
                    <div class="pencil_hoverthis">
                        <input type="checkbox" id="declearation_checkbox"
                            ...
                            checked />
                        <p contentEditable="false" style="margin: 0px;margin-top: 0px;">
            ...
            <tr>
                <td colspan="2" style="text-align: left;padding: 15px 0px 0px 15px;font-size: 12pt;">
                    <b class="bold" style="font-family: Calibri;display: inline-block;
                            margin-right: 10px;">Date
                        :</b>
                    <div style="outline: none;display: inline-block;" contenteditable="true" id="resume_date">
                        {{\Carbon\Carbon::now()->format('d-M-Y')}}
                    </div>
                </td>
                <td colspan="3" id="tour_user_place"
                    style="padding: 15px 0px 0px 15px;font-size: 12pt;text-align: right;">
                    <b class="bold" style="font-family: Calibri;margin-right: 10px;display: inline-block;">Place
                        : </b>
                    <div contenteditable="true" style="display: inline-block;outline: none;" id="resume_location">
                        <!-- Jabalpur -->
                    </div>
                </td>
            </tr>
