...
<div class="container header">
    <div class="row inner_header">
        <div class="">
            <div class="logo main">
                <a href="{{url('/')}}">
                    <img class="top_logowhite" src="{{url('public/front/jobsearch').'/'}}images/logo1.png"
                        alt="Happiest Logo">
                    <img class="top_logoblack" src="{{url('public/front/jobsearch').'/'}}images/logo1.png"
                        alt="Happiest Logo">
                </a>
            </div>
        </div>
        ...
        <div class="pull-right">
            <nav class="text-right main-menu">
                ...
                <ul class="top_menu_ul list-unstyled nav-menu" id="res_menucontainer">
                    ...
                    <li>
                        <a class="page-scroll nav-link1" href="{{Request::is('/') ? "#templates" : URL::to('/#templates')}}">
                            Templates
                        </a>
                    </li>
                    
                    <li>
                        <a class="page-scroll nav-link1" href="{{Request::is('/') ? "#contact" : URL::to('/#contact')}}">
                            contact
                        </a>
                    </li>
                    <li>
                  ...
                  <span class="sign_button">
                     @if(session()->has('user'))
                         ...
                         <a href="{{ url('resumelogin') }}" id="sign"
                          class="text-white btn btn-primary nav_button  waves-effect
