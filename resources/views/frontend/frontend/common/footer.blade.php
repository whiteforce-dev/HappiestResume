@php
    $registerations = \App\UserLogin_Model::where(['is_active' => 1])->orderBy('id', 'desc')->take(2)->get();
    $contactus = \App\ContactModel::where(['is_del' => 0])->first();
    $aboutus = \App\AboutUsModel::where(['is_del' => 0])->first();
@endphp
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-sm-6">
                ...
                <div class="footer_iconbox">
                    @php
                        $socialNetwork = App\SocialNetwork::where('is_active', 1)->get();
                    @endphp
