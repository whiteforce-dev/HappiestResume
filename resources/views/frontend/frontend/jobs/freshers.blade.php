                ...
                <div class="col-md-12">
                        <!-- <nav>
                            <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist"
                                ...
                                <a style="border: 1px solid rgb(194, 188, 188);"
                                    class="nav-item nav-link navbar-brand {{ $nationality == 'national' ? 'activeTab' : '' }}"
                                    onclick="searchJobsByCategory('national')" name="nationality" id="nav-home-tab"
                                    data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home"
                                    aria-selected="true"><b
                                        style="color: black; font-family: 'Arial, sans-serif">National
                                        Jobs</b></a>
                                <a style="border: 1px solid rgb(194, 188, 188);"
                                    class="nav-item nav-link navbar-brand {{ $nationality == 'international' ? 'activeTab' : '' }}"
                                    onclick="searchJobsByCategory('international')" name="nationality"
                                    id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab"
                                    aria-controls="nav-profile" aria-selected="false"><b
                                        style="color: black; font-family: 'Arial, sans-serif">International Jobs</b></a>
                            </div>
                        </nav> -->
                    </div>
