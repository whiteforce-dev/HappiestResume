...
#careers-detail-box .detail-title p, #careers-detail-box .exp-detail .left p, #careers-detail-box .exp-detail .right p {
...
<div class="icon-bar">
    <a href="https://www.facebook.com/sharer/sharer.php?u={{$page_url}}&title=Happiest+Jobs" class="facebook"><i class="fa fa-facebook"></i></a>
    <a href="https://twitter.com/intent/tweet?text=my share text&amp;url={{$page_url}}" class="twitter"><i class="fa fa-twitter"></i></a>
    <a href="https://wa.me/?text={{$page_url}}" class="google"><i class="fa fa-whatsapp"></i></a>
    <a href="http://www.linkedin.com/shareArticle?mini=true&amp;url={{$page_url}}&amp;title=my share text&amp;summary=dit is de linkedin summary" class="linkedin"><i class="fa fa-linkedin"></i></a>
...
<div class="full_width">
    <div class="full_width_inner">
        ...
        <div class="vc_row wpb_row section vc_row-fluid  grid_section mpc-row"
            style="background-image:url('{{ url('public/12.jpg') }}'); text-align:left;">
                    ...
                    <div class="wpb_column vc_column_container vc_col-sm-12 mpc-column"
                        ...
                        <div class="vc_column-inner ">
                            <div class="wpb_wrapper">
                                        ...
                                        <div id="careers-detail-box">
                                            <div class="detail-title">
                                                <h1>{{ strtoupper($job->position) }}</h1>
                                                 <p style="font-weight: 700;"><a href="{!! isset($job->company->website)?$job->company->website:'#' !!}">{!! isset($job->company->name)? ucwords($job->company->name):'-' !!}</a>  &nbsp;|&nbsp;&nbsp; {{ ($job->job_location) }} &nbsp;|&nbsp;&nbsp; {!! isset($job->hh_id)?"SS_JOB$job->hh_id" : "SS_JOB_$job->id" !!}</p>
                                            </div>
                                            <div class="career-detail">
                                                <ul>
                                                    <li><b style="font-weight: 700;">Job Description  : </b><br>{!! $job->job_description !!}</li>

                                                </ul>
                                                <ul>
                                                    <li><b style="font-weight: 700;">About Company : </b><br>{!! $job->company->name !!}</li>

                                                </ul>

                                                <ul>
                                                    <li><b style="font-weight: 700;">Education : </b><br>{!! $job->education_required !!} </li>

                                                </ul>
                                                <ul>
                                                    <li><b style="font-weight: 700;">Required Skills : </b><br>{!! $job->skills_required !!}</li>
                                                ...
                                                <div class="exp-detail">
                                                    ...
                                                    <div class="left">
                                                        <ul>
                                                            <li><b style="font-weight: 700;">Experience : </b> {{$job->experience_year_from}}
                                                    ...
                                                    <div class="right">
                                                        <ul>
                                                            @if(is_numeric($job->package_offer_from) && is_numeric($job->package_offer_to))
                                                            <li><b style="font-weight: 700;">Package : </b> &nbsp;{{ number_format($job->package_offer_from) }}
                                                                To {{ number_format($job->package_offer_to) }} <b style="font-weight: 500;">Per Annum </b></li>
                                                                @else
                                                                <li><b style="font-weight: 700;">Package : </b> &nbsp;{{ ($job->package_offer_from) }}
                                                                To {{ ($job->package_offer_to) }} <b style="font-weight: 500;">Per Annum </b></li>
                                                                @endif
                                                ...
                                                <div class="exp-detail">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-4">
                                                            <ul>
                                                                <li><b style="font-weight: 700;">Manager Name : </b><br>{!! isset($job->hr_name)?ucwords($job->hr_name):'-' !!}</li>
                                                            </ul>
                                                        </div>
                                                        <div class="col-sm-4">
                                                            <ul>
                                                                <li><b style="font-weight: 700;">Manager Email : </b><br>{!! isset($job->hr_email)?$job->hr_email:'-' !!} </li>

                                                            </ul>
                                                        </div>
                                                        <div class="col-sm-4">
                                                            <ul>
                                                                <li><b style="font-weight: 700;">Manager Contact : </b><br> {!! isset($job->hr_contact)?$job->hr_contact:'-' !!}</li>
                                        ...
                                        href="https://api.whatsapp.com/send?phone={{ $job->hr_contact }}&text={{ $message }}&source=&data=&app_absent="><span
                                            ...
                                            Whatsapp</span></a>
                                                        ...
                                                        <div class="col-sm-4">
                                                              ...
                                                              @else
                                                              <a href="{{ url('resumeloginJob/'.$jid.'/'.$portal) }}" class="btn-1">Click To Apply</a>
                                ...
                                <div class="ult-spacer spacer-5efade6201358" data-id="5efade6201358" data-height="150"
                                    data-height-mobile="100" data-height-tab="100" data-height-tab-portrait=""
                                    data-height-mobile-landscape="" style="clear:both;display:block;"></div>
                            </div>
                        </div>
