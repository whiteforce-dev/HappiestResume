   ...
   <section id="formHolder">
      ...
      <div class="row">
         ...
         <div class="col-sm-6 brand">
            <div style="text-align: center;"><img class="top_logoblack" src="https://happiestresume.com/public/front/jobsearch/images/logo1.png" alt="Happiest Logo" align="middle"></div> 

            <div class="heading">
               <h2 style="color:#f8e71c">Welcome</h2>
               <br>
               <p>You are 30 seconds away from creating you professional resume.</p>
               <!-- <img src="{{url('public/front').'/'}}images/HAPPIEST-RESUME.png" alt="" class="responsive" width="600" height="400"> -->
               <br>
               <!-- <h4 id="log_reg">Register</h4> -->
            </div>
         ...
         <div class="col-sm-6 form">
            ...
            <div class="login form-peice switched">
               ...
               <div class="form-group">
                        ...
                        <a target="_blank" href="{{url('redirect/google')}}" style="text-decoration: none;color: white;"
            ...
            <div class="signup form-peice">
               ...
               <form class="signup-form" action="{{url('registration')}}" method="post" >
                   @csrf
                  ...
                  <div class="form-group">
                     ...
                     <select name="is_fresher" id="is_fresher" class="form-control" style="padding-top: 38px;">
