...
<head>
    ...
    {{--<link href="{{ URL::to('public/front').'/' }}css/pdfbootstrap.css" rel="stylesheet" type="text/css"/>--}}
                                        ...
                                        <tr onclick="selectedrow(this);" class="selectedrow">
                                            <td colspan="5">
                                                ...
                                                <span class="number_bullet_container">
                                                    <p contentEditable=true data-text="Enter your title here" class="textWithSpace required" id="title"
                                            ...
                                            <td colspan="5">
                                                <div class="pencil_hoverthis"
                                                    ...
                                                    <p id="resu_html_conno" onkeyup="Focusoutsection();"
                                                       ...
                                                       style="outline: none;">@if(isset($user->contact)) {{$user->contact}} @endif
                                                    </p>
                                            ...
                                            <tr onclick="selectedrow(this);" class="">
                                                <td valign="top" colspan="5" style="text-align: center;">
                                                    <div class="resu_archivement_fileblock" id="tour_user_achivement_img"
                                                        ...
                                                        @if(file_exists($user_achievemt->image)))
                                        ...
                                        <tr>
                                            <td colspan="5" id="tour_user_skills">
                                                <div class="pencil_hoverthis resu_skillblock res_margin0"
                                                     style="padding: 15px;background: #f5f5f5;display: inline-block;position: relative;z-index: 5;outline: none;margin-bottom: 15px;width: 100%;">
                                                    <h5 style="outline:none;font-family: Calibri;font-size: 26px;margin-bottom: 8px; font-weight: bold;padding-bottom: 10px;border-bottom: solid thin #cccccc;">
                                                        Skills</h5>
                                                    <span class="number_bullet_container">
                                                <p contenteditable="true" unselectable="on" onkeyup="Focusoutsection();"
                                                   onfocus="Focussection('resu_per_skills');" id="resu_html_skills"
                                                   style="margin:0px;outline: none;" contentEditable="true" required-message="Please enter your skills"
...
<script type="text/javascript">
        $(document).ready(function () {
            window.onload = function (e) {
                ...
                $('#preview_html').find('button').remove();
                $('#preview_html').find('.file_upload').remove();
                $('#preview_html').find('.tooltip').remove();

                if($("#declearation_checkbox"). prop("checked") == true)
                {
                    $('#preview_html').find('#declearation_checkbox').attr('checked', true);
                }

                let chkpresent = $('#preview_html').find('.hidepresent').css('display');
                if (chkpresent == 'block') {
                    $('#preview_html').find('#checkbox-present-box').hide();
                } else {
                    $('#preview_html').find('#present-checkbox-sign').hide();
                }
            }
    ...
    {{--var sUrl = '{{url('resume')."/$name/".base64_encode($user->id)}}';--}}
