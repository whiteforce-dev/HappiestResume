...
<section class="pb-4 pt-8 bg-white" id="about">
    <div class="container py-3 px-6" style="position: relative;">
        ...
        <div class="row">
            ...
            @foreach ($howItWorks as $key=>$howItWork) --}}
            <div class="card col-sm-3 col-md-3 col-lg-3 p-4 border-0" style="background: none;"
                data-aos="fade-up-right':'fade-up-left" data-aos-duration="1000">
                <div class="card-content">
                    {{-- @if(file_exists($howItWork->icon)) --}}
                    <img src="{{url('front/images/export.png')}}" style="width: 32px">
                    {{-- @else
                    <img src="{{url('public/front').'/'}}images/register.png" style="width: 32px">
                    @endif --}}
                    <h6 style="margin-top:10px">Export and Send</h6>
                    <p>Once your content is complete, you can export your resume in PDF form, from the free resume builder. Your latest version is saved and you can always go back to make edits.</p>
                </div>
            </div>
            <div class="card col-sm-3 col-md-3 col-lg-3 p-4 border-0" style="background: none;"
                data-aos="fade-up-right':'fade-up-left" data-aos-duration="1000">
                <div class="card-content">
                    {{-- @if(file_exists($howItWork->icon)) --}}
                    <img src="{{url('front/images/content.png')}}" style="width: 32px">
                    {{-- @else
                    <img src="{{url('public/front').'/'}}images/register.png" style="width: 32px">
                    @endif --}}
                    <h6 style="margin-top:10px">Optimize Your Content</h6>
                    <p>Each resume template is organized into major content sections. You can add or remove specific sections based on your needs.</p>
                </div>
            </div>
            <div class="card col-sm-3 col-md-3 col-lg-3 p-4 border-0" style="background: none;"
                data-aos="fade-up-right':'fade-up-left" data-aos-duration="1000">
                <div class="card-content">
                    {{-- @if(file_exists($howItWork->icon)) --}}
                    <img src="{{url('front/images/resume.png')}}" style="width: 32px">
                    {{-- @else
                    <img src="{{url('public/front').'/'}}images/register.png" style="width: 32px">
                    @endif --}}
                    <h6 style="margin-top:10px">Choose a Resume Layout</h6>
                    <p>You get to choose between several design options with our selection of free resume templates. This helps you match your resume to the type of company and position you want.</p>
                </div>
            </div>
            <div class="card col-sm-3 col-md-3 col-lg-3 p-4 border-0" style="background: none;"
                data-aos="fade-up-right':'fade-up-left" data-aos-duration="1000">
                <div class="card-content">
                    {{-- @if(file_exists($howItWork->icon)) --}}
                    <img src="{{url('front/images/register.png')}}" style="width: 32px">
                    {{-- @else
                    <img src="{{url('public/front').'/'}}images/register.png" style="width: 32px">
                    @endif --}}
                    <h6 style="margin-top:10px">Register in Happiest</h6>
                    <p>It only takes a couple of seconds to start using our online resume builder. The resume creator is offered completely through our website, meaning there is no software to download.</p>
                </div>
            </div>
            {{-- @endforeach
            @endif --}}
...
<section class="pb-4 pt-8 bg-white" id="templates">
    <div class="container py-3 resume-maker-guide">
        ...
        <div class="resumes_templates js-flickity" style="height: 600px;"
            ...
            <div class="resume-cell">
                <h6 class="text-center">Resume Yellow</h6>
                <img src="{{ url('resume_slider_images\1610019661.resume_yellow_new.jpg') }}"
                    alt="">
            </div>
            <div class="resume-cell">
                <h6 class="text-center">Resume Green Black</h6>
                <img src="{{ url('resume_slider_images\1613826923.GreenBlackResume.png') }}"
                    alt="">
            </div>
            <div class="resume-cell">
                <h6 class="text-center">Resume Green Grey</h6>
                <img src="{{ url('resume_slider_images\1613972488.ReusumeG.jpg') }}"
                    alt="">
            </div>
            <div class="resume-cell">
                <h6 class="text-center">Resume White</h6>
                <img src="{{ url('resume_slider_images\1613972996.resume.jpg') }}"
                    alt="">
            </div>
            <div class="resume-cell">
