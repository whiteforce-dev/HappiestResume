...
<head>
    ...
    <link href="{{url('public/front').'/'}}css/mdb.min.css" rel="stylesheet" type="text/css"/>
                    ...
                    <div class="col-lg-9 pull-right">
                        <nav class="text-right main-menu">
                            ...
                            <ul class="top_menu_ul list-unstyled" id="res_menucontainer">
                                <li><a class="page-scroll" href="{{Request::is('/') ? "#home" : URL::to('/#home')}}">HOME</a></li>
                                <li><a class="page-scroll" href="{{Request::is('/') ? "#about" : URL::to('/#about')}}">About</a></li>
                                <li><a class="page-scroll" href="{{Request::is('/') ? "#templates" : URL::to('/#templates')}}">Templates</a></li>
                                <li><a class="page-scroll" href="{{Request::is('/') ? "#testimonial" : URL::to('/#testimonial')}}">Testimonial</a></li>
                                <li><a class="page-scroll" href="{{Request::is('/') ? "#contact" : URL::to('/#contact')}}">contact</a></li>
                                <li><a class="page-scroll" target="_blank" href="{{URL::to('hot-jobs')}}">Jobs</a></li>
                            </ul>
                            <div class="before_login">
                                ...
                                @else
                                    ...
                                    <button type="button"
                                            ...
                                            id="login_btn" data-toggle="modal">LOGIN
                                    </button>
                                @endif
                            </div>
