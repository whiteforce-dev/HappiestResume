    ...
    <section class="heading" id="scrolling">
        <form>
            <section class="location">
                ...
                <div class="germany">
                    <a href="{{ url('country-jobs', ['us' ?? '0']) }}" class="card-img-top" style="text-decoration:none;">
                        
                        <img
                        src="{{ url('assets/international-img/germany.svg') }}" alt="">
                        <div class="country">
                            <h3>Jobs in USA</h3>
                    </a>
                    <div class="companies">
                ...
                <div class="usa">
                    ...
                    style="text-decoration:none !important;"> <img src="{{ url('assets/international-img/usa.svg') }}" alt="">
                        <div class="country">
            ...
            <div class="input-sec">
                <div class="what">
                    ...
                    <div class="left-icon">
                        <input type="text" class="text-holder" name="designation" placeholder="Job title or designation"
                            value="{{ $designation ?? '' }}">
