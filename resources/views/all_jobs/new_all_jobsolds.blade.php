...
<section class="heading" id="scrolling">
    ...
    <div class="input-sec">
        <div class="what">
            ...
            <div class="left-icon">
                <input type="text" class="text-holder" name="job_title" placeholder="Job title, skill or company">
        ...
        <div class="where">
            ...
            <div class="left-icon">
                <input type="text" class="text-holder location-input" name="job_title"
   ...
   <h1>
    ...
    <div class="container-card" style="margin-top: 60px;">
      ...
      <div class="box-card">
        ...
        @endif
            <div class="card-name-first">
              ...
              <span>
                <i class="fa-solid fa-location-dot"></i>  {{ isset($job->job_location) && $job->job_location != ' ' ? ucwords($job->job_location) : 'Work From Home' }}
              </span>
            </div>
          </div>
        </div>
        ...
        <div class="w-full">
          <p>
            {{substr( $job->job_description,0,160) }} ... <a style="text-decoration: none;" href={{ url('job-description', [$job->id]) }}><span class="trigger" style=" 
              color: #1d1d22;
              font-weight: 600;
              font-size: 0.9rem;
              margin: 0;
        ...
        <div class="applied">
          <div class="amount">
            <span class="price">  @if ($job->salary_type == 'USD')
              ${{ $job->package_offer_from }} - <br> $
              {{ $job->package_offer_to }} USD
          @else
              ₹{{ $job->package_offer_from }} - <br> ₹
              {{ $job->package_offer_to }} 
          @endif</span><span class="muted">/ Month</span>
          </div> 
          <div class="app-bttn">
      ...
      <div class="box-card">
        <div class="top-box">
          <div class="left-top">
            <img src="./job-img/ibm.png" alt="" style=" width:55px !important;">
            <div class="card-name-first">
              <p>IBM</p>
              <span>
                <i class="fa-solid fa-location-dot"></i> Jabalpur MP
      ...
      <div class="box-card">
        <div class="top-box">
          <div class="left-top">
            <img src="./job-img/linkdin.png" alt="" />
            <div class="card-name-first">
      ...
      <div class="box-card">
        <div class="top-box">
          <div class="left-top">
            <img src="./job-img/download.png" alt="" />
            <div class="card-name-first">
              <p>Meta</p>
              <span>
                <i class="fa-solid fa-location-dot"></i> Jabalpur MP
      ...
      <div class="box-card">
        <div class="top-box">
          <div class="left-top">
            <img src="./job-img/wipro.jpg" alt=""  style="width: 90px;">
            <div class="card-name-first">
              <p>Wipro</p>
              <span>
                <i class="fa-solid fa-location-dot"></i> Jabalpur MP
