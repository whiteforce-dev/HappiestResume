...
<form>
    <div class="input-sec">
        <div class="what">
            ...
            <div class="left-icon">
                <input type="text" class="text-holder" name="designation" placeholder="Job title, designation " value="{{ $designation ?? '' }}">
        ...
        <div class="where">
            ...
            <div class="left-icon">
                <input type="text" class="text-holder location-input" name="job_location"
                    placeholder="Town, city" value="{{ $location ?? '' }}">
                <i class="far fa-compass"></i>
              
            </div>
            <input type="hidden" name="job_category" value="female" id="">
        </div>
        <div class="find-btn">
...
<section class="keep-card" style="margin-top: 20px;">
    <h1>
        Female J<i class="fas fa-search" style="color: rgb(255, 153, 0); font-size: 19px;"></i>bs</h1>
    ...
    <div class="container-card" style="margin-top: 60px;">
      ...
      <div class="box-card">
        ...
        <div class="w-full">
          <p>
            {!! substr( $job->job_description,0,75) !!}  ... <a style="text-decoration: none;" href={{ url('job-description', [$job->id]) }}><span class="trigger" style=" 
              color: #1d1d22;
              font-weight: 600;
              font-size: 0.9rem;
              margin: 0;
