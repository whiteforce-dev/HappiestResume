...
@section('content')
    ...
    <div class="panel mybg">
        <div class="panel-heading">
            <h3 class="panel-title">Create Job
                {{-- <span class="panel-desc">Manage Your All Category </span> --}}
            </h3>
        </div>
        <div class="panel-body">

            <form action="{{ url('jobs') }}" method="post" id="myid" autocomplete="off"
                    ...
                    <div class="col-xl-6 form-horizontal">
                        ...
                        <div class="form-group form-material">
                            ...
                            <div class="col-xl-12 col-md-9">
                                ...
                                @php
                                    $already_selected_value = isset($year)?$year:"0";
                                    $earliest_year = 20;
                        ...
                        <div class="form-group form-material">
                            ...
                            <div class="col-xl-12 col-md-9">
                                <select name="employment_type" class="form-control" id="employment_type">
                                    ...
                                    <option value="Fixed term and contract">Fixed term and contract</option>
                                    <option value="Apprentices and trainees">Apprentices and trainees</option>
                                    <option value="Commission and piece rate">Commission and piece rate</option>
                                </select>
                            </div>
                        </div>
                    </div>
