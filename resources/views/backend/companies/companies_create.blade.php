...
<div class="panel mybg">
    <div class="panel-heading">
        <h3 class="panel-title">Update Testimonial
            ...
            <div class="container" align="center">
                <div class="form-group row form-material">
                    ...
                    <div class="col-xl-12 col-md-9">
                        <img style="height:150px ;width:auto;" src="{{ url('').'/'.$testimonial->image }}" alt="">
                        <input type="hidden" name="oldImage" id="oldImage" value="{{$testimonial->image}}">
                    </div>
                </div>
            </div>
                    ...
                    <div class="form-group form-material">
                        ...
                        <div class="col-xl-12 col-md-9">
                            <input type="text" class="form-control required" name="name" id="name"
                                value="{{$testimonial->name}}" placeholder="Enter Associate Name"
                    ...
                    <div class="form-group form-material">
                        ...
                        <div class="col-xl-12 col-md-9">
                            <select type="text" name="is_active" id="is_active" class="form-control required">
                                ...
                                <option value="0" {{ $testimonial->is_active == '0'?'selected':'' }}>In-Active</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group form-material">
                        ...
                        <div class="col-xl-12 col-md-9">
                            <textarea name="comment" id="comment" placeholder="Associate Comments Here..." rows="6"
                                class="form-control required">{{ $testimonial->comment }}</textarea>
