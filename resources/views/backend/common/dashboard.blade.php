            ...
            <div class="card">
                <div class="card-block">
                    <div class="row align-items-center">
                        <div class="col-8">
                            <h4 class="text-c-yellow f-w-600">{{0}}</h4>
                            <h6 class="text-muted m-b-0">All Resumes</h6>
                        </div>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card">
                <div class="card-block">
                    <div class="row align-items-center">
                        <div class="col-8">
                            <h4 class="text-c-green f-w-600">{{0}}</h4>
                            <h6 class="text-muted m-b-0">All Jobs</h6>
                        </div>
                        <div class="col-4 text-right">
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card">
                <div class="card-block">
                    <div class="row align-items-center">
                        <div class="col-8">
                            <h4 class="text-c-pink f-w-600">{{0}}</h4>
                ...
                <div class="card-block">
                    <div class="row align-items-center">
                        <div class="col-8">
                            ...
                            <h6 class="text-muted m-b-0">Applied Jobs</h6>
                        </div>
                        <div class="col-4 text-right">
